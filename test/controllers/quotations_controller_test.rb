...
class QuotationsControllerTest < ActionController::TestCase
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post :create, quotation: { company: @quotation.company, email: @quotation.email, message: @quotation.message, name: @quotation.name, telephone: @quotation.telephone }
    end
  ...
  test "should update quotation" do
    patch :update, id: @quotation, quotation: { company: @quotation.company, email: @quotation.email, message: @quotation.message, name: @quotation.name, telephone: @quotation.telephone }
    assert_redirected_to quotation_path(assigns(:quotation))
  end
